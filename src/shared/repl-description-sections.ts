...
export const AVAILABLE_FUNCTIONS = [
  ...
  "",
  "### When to Use",
  "- Multi-page scraping workflows (SPA/CSR sites that need JS rendering)",
  "- Navigating to different URLs",
  "",
  "### Do NOT Use For",
  "- Single page interactions (use native functions)",
  "- Inside browserjs() (closures don't work)",
  "- Multi-URL fetching of static / server-rendered pages — use `sandboxFetch` instead",
  "",
  "```javascript",
  ...
  "```",
  "",
  "## sandboxFetch(url, options?) — Multi-URL fetch that bypasses the AI context",
  "",
